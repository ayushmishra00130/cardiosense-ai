...
const STORAGE_KEY = "cardiosense-latest-assessment";
...
function registerGaugePlugin() {
    if (!window.Chart || window.__cardioGaugePluginRegistered) {
        return;
    }
    ...
    window.__cardioGaugePluginRegistered = true;
}
...
function initResultsPage() {
    ...
    const activeBundle = chooseLatestBundle(serverBundle, storageBundle);
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener("click", async () => {
            ...
            try {
                ...
                anchor.href = fileUrl;
                anchor.download = "CardioSense_Medical_Summary.pdf";
